$(function () {
    ...
    if (id_value_string == "") {
        ...
        $.ajax({
            ...
            method: 'GET',
            cache: false,
            url: 'https://donnguyen.herokuapp.com/api/Building/CustomerId/' + id_value_string,
            timeout: 5000,
    ...
    $("select#building").change(function () {
        ...
        if (id_value_string == "") {
            ...
            $.ajax({
                ...
                method: 'GET',
                cache: false,
                url: 'https://donnguyen.herokuapp.com/api/Batteries/buildingId/' + id_value_string,
                timeout: 5000,
                error: function (XMLHttpRequest, errorTextStatus, error) {
                    alert("Failed to submit : " + errorTextStatus + " ;" + error);
                },
    ...
    $("select#battery").change(function () {
        ...
        if (id_value_string == "") {
            ...
            $.ajax({
                ...
                method: 'GET',
                cache: false,
                url: 'https://donnguyen.herokuapp.com/api/Columns/batteriesId/' + id_value_string,
                timeout: 5000,
                error: function (XMLHttpRequest, errorTextStatus, error) {
                    alert("Failed to submit : " + errorTextStatus + " ;" + error);
                },
    ...
    $("select#column").change(function () {
        ...
        if (id_value_string == "") {
            ...
            $.ajax({
                dataType: "json",
                cache: false,
                url: 'https://donnguyen.herokuapp.com/api/Elevators/columnId/' + id_value_string,
                timeout: 5000,
                error: function (XMLHttpRequest, errorTextStatus, error) {
                    alert("Failed to submit : " + errorTextStatus + " ;" + error);
                },
    ...
    $("#intervention").submit(function (e) {
        ...
        $.ajax({
            ...
            url: 'https://donnguyen.herokuapp.com/api/Interventions',
            success: function (data) {
